...
import { LuLayoutDashboard, LuTable2 } from "react-icons/lu";
...
const Sidebar = ({ isOpen, closeSidebar }: SidebarProps) => {
  ...
  return (
    <Fragment>
      <div
        className={clsxm(
          "z-50 flex flex-col w-64 h-screen px-5 py-8 overflow-y-auto bg-white dark:bg-gray-900 dark:border-gray-700 rounded-r-xl fixed md:relative transform transition duration-200 ease-in-out md:translate-x-0 shadow-2xl",
      ...
      <div
        id="backdrop"
        className={clsxm(
          "absolute bg-black/5 w-screen h-screen z-[45] backdrop-blur md:hidden",
          isOpen ? "block" : "hidden"
        )}
        onClick={() => closeSidebar()}
      />
